...
contract LotteryProject {
    ...
    // ประกาศ Event สำหรับบันทึกการซื้อหวย
    event LotteryBought(address indexed player, uint timestamp);
    // ประกาศ Event สำหรับบันทึกผู้ถูกรางวัล
    ...
    // Modifier สำหรับตรวจสอบสิทธิ์ของ admin
    modifier onlyAdmin() {
        require(msg.sender == admin, "Only the admin can call this function.");
        _;
    }

    // ฟังก์ชันแสดงยอดเงินรางวัลทั้งหมดใน Smart Contract
    ...
    function buyLottery() public payable {
        ...
        // เรียก Event สำหรับบันทึกการซื้อหวย
        emit LotteryBought(msg.sender, block.timestamp);
    }

    // ฟังก์ชันดูขนาดผู้เล่นในแต่ละรอบ
