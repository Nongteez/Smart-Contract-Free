...
contract FundMe{
    ...
    function fund() public payable {
        ...
        require(getConversationRate(msg.value) >= MinimumUSD , "You Need To Pay More210 NAJA");
        require(getConversationRate(msg.value) <= MaximumUSD , "You Need To Pay 520 NAJA");
